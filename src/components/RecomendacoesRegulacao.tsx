...
interface RecomendacoesRegulacaoProps {
  tipo: string;
  formatoExportacao?: boolean;
}

const RecomendacoesRegulacao: React.FC<RecomendacoesRegulacaoProps> = ({ tipo, formatoExportacao = false }) => {
  // Se for formato de exportação, renderiza o conteúdo sem as abas
